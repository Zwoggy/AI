    ...
    if train:
        ...
        with strategy.scope():
            ...
            if old:
                ...
                esm_model = TFEsmForTokenClassification(add_cross_attention=True).from_pretrained("facebook/esm2_t33_650M_UR50D")
            ...
            history = model.fit(x = antigen_list, y = epitope_list, batch_size = 16, epochs = 30,
