...
def create_ai(filepath, save_file, output_file, train=False, safe=False, validate_45_Blind=False, validate_BP3C=False, predict=False, old=False, gpu_split=False, big_dataset=True, use_structure=False):
    ...
    num_transformer_blocks = 8 # used to be 2
    num_decoder_blocks = 8 # used to be 1
    embed_dim = 100  # Embedding size for each token used to be 24
    num_heads = 20  # Number of attention heads; used to be 40
    ff_dim = 200  # Hidden layer size in feed forward network inside transformer; used to be 32
