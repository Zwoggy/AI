...
def calculating_class_weights(y_true):
    ...
    for i in range(len(weights)):
        weights[i][1] = weights[i][1] / 0.6  # optional Scaling; used to be 2.2; 0.75, 0.85 #//// 1.0 for BP3 training-set #/// 0.25 for old_data_set # for structure BP3_train 0.45 worked
